            ...
            <div className="down-menu">
              ...
              <li>
                <Link to="" className="default-links">
                  <Tooltip className="normal-links" title="Аккаунт" style={{ padding: '6px 0' }}>
                  ...
                  <span className="link_name link_mail" style={{ wordBreak: 'break-word' }}>{`${decodeToken.email}`}</span>
                </Link>
                <ul className="sub-menu blank">

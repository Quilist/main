...
function InformationForm({ address, setAddress, arrears, setArrears, discount, setDiscount, note, setNote, setMainArreas, codeNdc, id }) {
  ...
  return (
    <>
      ...
      <TextField
        id="standard-multiline-flexible" variant="outlined" label="НДС:" multiline maxRows={2} value={codeNdc || ''}
        onClickCapture={(e) => {alert("Вы можете изменить НДС. Введите EDRPOU, и нажмите поиск для автозаполнения."); e.target.blur()}}
      />
